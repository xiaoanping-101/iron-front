...
function update(){
 ...
 for(const b of bullets){const from={x:b.x,z:b.z,alt:b.alt};b.x+=b.vx;b.z+=b.vz;b.alt+=b.va;b.y=groundAt(b.x,b.z)-b.alt;b.life--;const impact=coverImpact(b,from);if(impact){b.x=from.x+(b.x-from.x)*impact.t;b.z=from.z+(b.z-from.z)*impact.t;b.alt=from.alt+(b.alt-from.alt)*impact.t;b.y=groundAt(b.x,b.z)-b.alt;b.life=0;burst(b.x,b.y,'#e9c18a',3,b.z);continue}if(b.owner==='player'){for(const e of [...enemies,boss]){if(e.hp>0&&(e!==boss||boss.active)&&projectileHits(b,e)){damage(e,1);b.life=0;break}}}else if(projectileHits(b,p)){hurt();b.life=0}}
